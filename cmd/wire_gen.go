...
func InitApp() *App {
	...
	controller := pers_amount_total.New(dataBase)
	initControllers := pers_amount_total.NewRouter(controller)
	engine := http.NewRouter(configConfig, logger, initControllers)
